...
class ElasticsearchServiceSync:
    ...
    def create_document(self, document, id=None):
        ...
        try:
            self.es.index(index=self.index_name, id=doc_id, body=doc_data)
    ...
    def update_document(self, doc_id: str, update_data):
        """Update a document"""
        try:
            # Prepare update data
    ...
    def bulk_update(
        self, actions: Generator[Dict[str, Any], None, None]
    ) -> Dict[str, Any]:
        """
