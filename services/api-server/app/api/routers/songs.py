...
async def get_song_status(video_id: str):
...
async def download_song_zip(video_id: str):
    ...
    # Use FileResponse to send the zip file to the client
    return FileResponse(
        path=zip_path, 
