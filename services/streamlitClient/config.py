...
class StreamlitConfig:
    ...
    api_base_url: str = os.getenv("STREAMLIT_API_BASE_URL", "http://localhost:8000")

    # Logging configuration
    title: str = os.getenv("STREAMLIT_TITLE", "streamlitClient")
    es_url_logs: str = os.getenv("STREAMLIT_ES_URL_LOGS", "http://localhost:9200")
    es_index_logs: str = os.getenv("STREAMLIT_ES_INDEX_LOGS", "logs")
