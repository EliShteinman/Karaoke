...
### 4. תמלול השיר
1. **טעינת מודל** Whisper Large v3 (או מטמון קיים)
2. **זיהוי שפה** אוטומטי (בעיקר אנגלית)
3. **Voice Activity Detection** לזיהוי קטעי שירה vs. כלי נגינה
4. **תמלול מלא** עם timestamps ברמת מילה
5. **הערכת אמינות** התמלול (confidence score)
